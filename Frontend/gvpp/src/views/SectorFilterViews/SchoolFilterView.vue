...
const filteredSchools = computed(() => schoolsData.value);
...
async function applyFilters() {
  ...
  schoolsData.value = schoolsData.value.filter((escaperoom) => {
  ...
  schoolsData.value.forEach((escaperoom) => {
  ...
  schoolsData.value = schoolsData.value.filter((escaperoom) => escaperoom.rooms.length > 0);
}
...
onMounted(async () => {
  filteredSchools.value = schoolsData.value;
